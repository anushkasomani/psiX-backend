...
*/
import * as ffjavascript$1 from 'ffjavascript';
import { buildBn128 as buildBn128$1, Scalar, utils, BigBuffer } from 'ffjavascript';
...
var require$$0$1 = /*@__PURE__*/getAugmentedNamespace(ffjavascript$1);
...
var require$$0 = /*@__PURE__*/getAugmentedNamespace(_virtual_fs$1);
...
var _virtual_constants = /*#__PURE__*/Object.freeze({
    __proto__: null,
    O_CREAT: O_CREAT,
    O_EXCL: O_EXCL,
    O_RDONLY: O_RDONLY,
...
var require$$1 = /*@__PURE__*/getAugmentedNamespace(_virtual_constants);

Object.defineProperty(main, '__esModule', { value: true });

function _interopDefault (ex) { return (ex && (typeof ex === 'object') && 'default' in ex) ? ex['default'] : ex; }

var fs = _interopDefault(require$$0);
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    _b = _a;
                    return [3 /*break*/, 3];
                case 1: return [4 /*yield*/, buildBn128$1()];
                case 2:
                    _b = (_c.sent());
                    _c.label = 3;
                case 3: 
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    n8 = (Math.floor((Scalar.bitLength(prime) - 1) / 64) + 1) * 8;
...
/* eslint-disable eqeqeq */
/* istanbul ignore file */
var unstringifyBigInts$2 = utils.unstringifyBigInts;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, WitnessCalculatorBuilder(wasm)];
                case 4:
                    wc = _a.sent();
...
/* istanbul ignore file */
var stringifyBigInts = utils.stringifyBigInts, unstringifyBigInts$1 = utils.unstringifyBigInts;
function buildABC1(curve, zkey, witness, coeffs) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            outBuffA = new BigBuffer(zkey.domainSize * n8);
            outBuffB = new BigBuffer(zkey.domainSize * n8);
            outBuffC = new BigBuffer(zkey.domainSize * n8);
...
/* eslint-disable @typescript-eslint/naming-convention */
/* istanbul ignore file */
var unstringifyBigInts = utils.unstringifyBigInts;
...
export { buildBn128, prove, verify };
